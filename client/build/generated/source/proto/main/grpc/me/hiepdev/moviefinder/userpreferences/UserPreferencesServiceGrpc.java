...
@javax.annotation.Generated(
    ...
    comments = "Source: moviefinder/userpreferences/userpreferences.proto")
...
public final class UserPreferencesServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<me.hiepdev.moviefinder.userpreferences.UserPreferencesRequest,
      me.hiepdev.moviefinder.userpreferences.UserPreferencesResponse> getGetShortlistedMoviesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getShortlistedMovies",
      requestType = me.hiepdev.moviefinder.userpreferences.UserPreferencesRequest.class,
      responseType = me.hiepdev.moviefinder.userpreferences.UserPreferencesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<me.hiepdev.moviefinder.userpreferences.UserPreferencesRequest,
      me.hiepdev.moviefinder.userpreferences.UserPreferencesResponse> getGetShortlistedMoviesMethod() {
    io.grpc.MethodDescriptor<me.hiepdev.moviefinder.userpreferences.UserPreferencesRequest, me.hiepdev.moviefinder.userpreferences.UserPreferencesResponse> getGetShortlistedMoviesMethod;
      ...
      synchronized (UserPreferencesServiceGrpc.class) {
        if ((getGetShortlistedMoviesMethod = UserPreferencesServiceGrpc.getGetShortlistedMoviesMethod) == null) {
          UserPreferencesServiceGrpc.getGetShortlistedMoviesMethod = getGetShortlistedMoviesMethod =
              io.grpc.MethodDescriptor.<me.hiepdev.moviefinder.userpreferences.UserPreferencesRequest, me.hiepdev.moviefinder.userpreferences.UserPreferencesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getShortlistedMovies"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.hiepdev.moviefinder.userpreferences.UserPreferencesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.hiepdev.moviefinder.userpreferences.UserPreferencesResponse.getDefaultInstance()))
  ...
  public static abstract class UserPreferencesServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<me.hiepdev.moviefinder.userpreferences.UserPreferencesRequest> getShortlistedMovies(
        io.grpc.stub.StreamObserver<me.hiepdev.moviefinder.userpreferences.UserPreferencesResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                me.hiepdev.moviefinder.userpreferences.UserPreferencesRequest,
                me.hiepdev.moviefinder.userpreferences.UserPreferencesResponse>(
  ...
  private static abstract class UserPreferencesServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return me.hiepdev.moviefinder.userpreferences.Userpreferences.getDescriptor();
    }
