...
@javax.annotation.Generated(
    ...
    comments = "Source: moviefinder/recommender/recommender.proto")
...
public final class RecommenderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<me.hiepdev.moviefinder.recommender.RecommenderRequest,
      me.hiepdev.moviefinder.recommender.RecommenderResponse> getGetRecommendedMovieMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getRecommendedMovie",
      requestType = me.hiepdev.moviefinder.recommender.RecommenderRequest.class,
      responseType = me.hiepdev.moviefinder.recommender.RecommenderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<me.hiepdev.moviefinder.recommender.RecommenderRequest,
      me.hiepdev.moviefinder.recommender.RecommenderResponse> getGetRecommendedMovieMethod() {
    io.grpc.MethodDescriptor<me.hiepdev.moviefinder.recommender.RecommenderRequest, me.hiepdev.moviefinder.recommender.RecommenderResponse> getGetRecommendedMovieMethod;
      ...
      synchronized (RecommenderServiceGrpc.class) {
        if ((getGetRecommendedMovieMethod = RecommenderServiceGrpc.getGetRecommendedMovieMethod) == null) {
          RecommenderServiceGrpc.getGetRecommendedMovieMethod = getGetRecommendedMovieMethod =
              io.grpc.MethodDescriptor.<me.hiepdev.moviefinder.recommender.RecommenderRequest, me.hiepdev.moviefinder.recommender.RecommenderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getRecommendedMovie"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.hiepdev.moviefinder.recommender.RecommenderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.hiepdev.moviefinder.recommender.RecommenderResponse.getDefaultInstance()))
  ...
  public static abstract class RecommenderServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<me.hiepdev.moviefinder.recommender.RecommenderRequest> getRecommendedMovie(
        io.grpc.stub.StreamObserver<me.hiepdev.moviefinder.recommender.RecommenderResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                me.hiepdev.moviefinder.recommender.RecommenderRequest,
                me.hiepdev.moviefinder.recommender.RecommenderResponse>(
  ...
  private static abstract class RecommenderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return me.hiepdev.moviefinder.recommender.Recommender.getDescriptor();
    }
