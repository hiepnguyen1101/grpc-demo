...
@javax.annotation.Generated(
    ...
    comments = "Source: moviefinder/moviecontroller/moviecontroller.proto")
...
public final class MovieControllerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<me.hiepdev.moviefinder.moviecontroller.MovieRequest,
      me.hiepdev.moviefinder.moviecontroller.MovieResponse> getGetMovieMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getMovie",
      requestType = me.hiepdev.moviefinder.moviecontroller.MovieRequest.class,
      responseType = me.hiepdev.moviefinder.moviecontroller.MovieResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<me.hiepdev.moviefinder.moviecontroller.MovieRequest,
      me.hiepdev.moviefinder.moviecontroller.MovieResponse> getGetMovieMethod() {
    io.grpc.MethodDescriptor<me.hiepdev.moviefinder.moviecontroller.MovieRequest, me.hiepdev.moviefinder.moviecontroller.MovieResponse> getGetMovieMethod;
      ...
      synchronized (MovieControllerServiceGrpc.class) {
        if ((getGetMovieMethod = MovieControllerServiceGrpc.getGetMovieMethod) == null) {
          MovieControllerServiceGrpc.getGetMovieMethod = getGetMovieMethod =
              io.grpc.MethodDescriptor.<me.hiepdev.moviefinder.moviecontroller.MovieRequest, me.hiepdev.moviefinder.moviecontroller.MovieResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getMovie"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.hiepdev.moviefinder.moviecontroller.MovieRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.hiepdev.moviefinder.moviecontroller.MovieResponse.getDefaultInstance()))
  ...
  public static abstract class MovieControllerServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getMovie(me.hiepdev.moviefinder.moviecontroller.MovieRequest request,
        io.grpc.stub.StreamObserver<me.hiepdev.moviefinder.moviecontroller.MovieResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                me.hiepdev.moviefinder.moviecontroller.MovieRequest,
                me.hiepdev.moviefinder.moviecontroller.MovieResponse>(
  ...
  public static final class MovieControllerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MovieControllerServiceBlockingStub> {
     ...
     * </pre>
     */
    public me.hiepdev.moviefinder.moviecontroller.MovieResponse getMovie(me.hiepdev.moviefinder.moviecontroller.MovieRequest request) {
  ...
  public static final class MovieControllerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MovieControllerServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<me.hiepdev.moviefinder.moviecontroller.MovieResponse> getMovie(
        me.hiepdev.moviefinder.moviecontroller.MovieRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MOVIE:
          serviceImpl.getMovie((me.hiepdev.moviefinder.moviecontroller.MovieRequest) request,
              (io.grpc.stub.StreamObserver<me.hiepdev.moviefinder.moviecontroller.MovieResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MovieControllerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return me.hiepdev.moviefinder.moviecontroller.Moviecontroller.getDescriptor();
    }
