...
@javax.annotation.Generated(
    ...
    comments = "Source: moviefinder/moviestore/moviestore.proto")
...
public final class MovieStoreServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<me.hiepdev.moviefinder.moviestore.MovieStoreRequest,
      me.hiepdev.moviefinder.moviestore.MovieStoreResponse> getGetMoviesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getMovies",
      requestType = me.hiepdev.moviefinder.moviestore.MovieStoreRequest.class,
      responseType = me.hiepdev.moviefinder.moviestore.MovieStoreResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<me.hiepdev.moviefinder.moviestore.MovieStoreRequest,
      me.hiepdev.moviefinder.moviestore.MovieStoreResponse> getGetMoviesMethod() {
    io.grpc.MethodDescriptor<me.hiepdev.moviefinder.moviestore.MovieStoreRequest, me.hiepdev.moviefinder.moviestore.MovieStoreResponse> getGetMoviesMethod;
      ...
      synchronized (MovieStoreServiceGrpc.class) {
        if ((getGetMoviesMethod = MovieStoreServiceGrpc.getGetMoviesMethod) == null) {
          MovieStoreServiceGrpc.getGetMoviesMethod = getGetMoviesMethod =
              io.grpc.MethodDescriptor.<me.hiepdev.moviefinder.moviestore.MovieStoreRequest, me.hiepdev.moviefinder.moviestore.MovieStoreResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getMovies"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.hiepdev.moviefinder.moviestore.MovieStoreRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.hiepdev.moviefinder.moviestore.MovieStoreResponse.getDefaultInstance()))
  ...
  public static abstract class MovieStoreServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getMovies(me.hiepdev.moviefinder.moviestore.MovieStoreRequest request,
        io.grpc.stub.StreamObserver<me.hiepdev.moviefinder.moviestore.MovieStoreResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                me.hiepdev.moviefinder.moviestore.MovieStoreRequest,
                me.hiepdev.moviefinder.moviestore.MovieStoreResponse>(
  ...
  public static final class MovieStoreServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MovieStoreServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<me.hiepdev.moviefinder.moviestore.MovieStoreResponse> getMovies(
        me.hiepdev.moviefinder.moviestore.MovieStoreRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MOVIES:
          serviceImpl.getMovies((me.hiepdev.moviefinder.moviestore.MovieStoreRequest) request,
              (io.grpc.stub.StreamObserver<me.hiepdev.moviefinder.moviestore.MovieStoreResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MovieStoreServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return me.hiepdev.moviefinder.moviestore.Moviestore.getDescriptor();
    }
